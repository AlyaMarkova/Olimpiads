...
<?php
	...
	if    (isset($login) and isset($email)) 
	{
		...
		else
		{
			...
			$message = "Здравствуйте,".$login."!\nМы сгенерировали для Вас пароль. Теперь Вы сможете войти на сайт, используя его. После входа желательно его сменить.\n\nПароль: ".$new_password."\n\nС уважением,\nАдминистрация olimpiada.ru";//текст сообщения
